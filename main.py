...
from methods_for_correction import correct_for_txt, correct_for_word

"""基于领域文本的自动纠错系统后端的主函数 by michael"""

"""1）首先使用using_baidu_WebApi模块来完成识别过程，并且得到txt文件"""

voice_filename = "cs音频/cs8.wav"            # 音频文件名称，必要的时候要写绝对地址
...
final_txt = correct_for_txt(uncorrected_txt, py_dic)
print('纠错后的结果为：' + final_txt)
save_file(final_filname, final_txt)                                                         # 保存纠错后的文本为txt文件
